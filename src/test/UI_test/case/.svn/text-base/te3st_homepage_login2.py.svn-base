...
from src.utils.getdb import db_mysql_connect,db_sqlserver_connect,db_sql_dict,unicode_dict
...
#             time.sleep(4)
    ...
    def test_homepage_login_by_db(self, db_mysql_conn=db_mysql_conn1):
        u"正常登录"
#         db_mysql_cursor = db_mysql_connect.cursor()
        ...
        aa = db_sql_dict(db_mysql_conn,sql1)
...
#             print lg_username,lg_pwd,acc
    ...
    def test_homepage_login_abnormal_by_db(self, db_mysql_conn=db_mysql_conn1):
        u"异常登录"
...
#     unittest.main()
    db_mysql_conn1 = db_mysql_connect()
    
    suite=unittest.TestSuite()
    #将测试用例加入到测试容器中
#     suite.addTest(TestHomePageLogin("test_homepage_login_by_db"))
    suite.addTest(TestHomePageLogin("test_homepage_login_abnormal_by_db"))
